...
public class Boleto
{
    ...
    public static Boleto EmitirSiHaySaldo(Tarjeta tarjeta, Colectivo colectivo, string lineaColectivo, DateTime fecha)
    {
        ...
        if (tarjeta.PuedeRealizarViaje(tarifa, fecha) && tarjeta.TieneSaldoSuficiente(tarifa))
        {
            tarjeta.DescontarSaldo(tarifa, fecha);
            return new Boleto(tarifa, fecha, tarjeta, lineaColectivo);
        }
        else
        {
