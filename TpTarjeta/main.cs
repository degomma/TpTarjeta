...
class MainClass
{
        ...
        while (true)
        {
            ...
            switch (opcion)
            {
                ...
                case "2":
                    ...
                    Boleto boleto = Boleto.EmitirSiHaySaldo(miTarjeta, colectivo, "Línea K", DateTime.Now);
                    if (boleto != null)
                    {
                        boleto.MostrarInfo();
                    }
    ...
    private static Tarjeta ElegirTipoDeTarjeta()
    {
        ...
        switch (tipo)
        {
            ...
            case "2":
                return new FranquiciaParcial(saldoInicial);
            case "3":
                return new FranquiciaCompleta(saldoInicial);
            default:
                return null;
        }
    }
